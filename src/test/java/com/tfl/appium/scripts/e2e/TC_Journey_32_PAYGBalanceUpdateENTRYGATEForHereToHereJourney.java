...
public class TC_Journey_32_PAYGBalanceUpdateENTRYGATEForHereToHereJourney extends AppiumEngine{
	...
	public void verifyOysterPAYGBalanceUpdateOnEntryGateForHereToHereJourney(ITestContext context,Hashtable<String, String> data)
			throws Throwable {
		...
		try {
				...
				txn.copyFileToDGC(txnFilePath, AppConstants.DGC_PATH,action);
				/*System.out.println("********** Waiting for the Here to Here Journey to happen *********** ");
