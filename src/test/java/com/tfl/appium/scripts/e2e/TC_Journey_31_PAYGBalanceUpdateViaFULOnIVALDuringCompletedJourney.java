...
public class TC_Journey_31_PAYGBalanceUpdateViaFULOnIVALDuringCompletedJourney extends AppiumEngine{
	...
	public void verifyOysterPAYGBalanceUpdateOnIvalDuringCompletedJourney(ITestContext context,Hashtable<String, String> data)
			throws Throwable {
		...
		try {
				...
				journeyHistory.verifyIvalJourneyHistory(context,entryStationName,exitStationName,action);
