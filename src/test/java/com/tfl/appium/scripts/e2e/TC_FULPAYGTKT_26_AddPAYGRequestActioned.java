...
public class TC_FULPAYGTKT_26_AddPAYGRequestActioned extends AppiumEngine{
	...
	public void verifyOysterTopUP(ITestContext context,Hashtable<String, String> data)
		...
		try {
			...
			String TransactionData2 =FileUtil.readFile(TransactionHeaderFile);
			String cardNumber = data.get("PrestigeCardNumber");
			String oysterCardVisibleNumberOnApp = "000"+cardNumber+JsonUtil.getJsonElement(TransactionData2, "$."+cardNumber+".NTMNoCheckDigits");
				...
				//Exporting tap files to Databases 
				...
				//Verify the balance update and journey history 				
