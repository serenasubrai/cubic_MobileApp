...
public class TC_AddOysterCard_03_HotlistedCard extends AppiumEngine{
	...
	public void addHotlistedCard(ITestContext context,Hashtable<String, String> data)
			throws Throwable {
		...
		try {
			...
			addOys.addHotlistedCard(context, data, action);
