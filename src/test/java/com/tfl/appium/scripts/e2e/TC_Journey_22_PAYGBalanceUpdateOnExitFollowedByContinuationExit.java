...
public class TC_Journey_22_PAYGBalanceUpdateOnExitFollowedByContinuationExit extends AppiumEngine{
	...
	public void verifyOysterPAYGBalanceUpdateOnExitFollowedByContiniousExit(ITestContext context,Hashtable<String, String> data)
			throws Throwable {
		...
		String TransactionFile3 = data.get("TransactionFile3");
		String TransactionData3 =FileUtil.readFile(TransactionFile3);
		Object ExitTransactionObject3 = JsonUtil.getJsonObject(TransactionData3, "$.Exit");
		String exitStationName3 = JsonUtil.getJsonObjectElement(ExitTransactionObject3, ".StationName");
		int curBal;
		...
		try {
				...
				txn.copyFileToDGC(txnFilePath, AppConstants.DGC_PATH,action);
				txnFilePath = txn.generateExitTransaction(data,TransactionFile3,ExitTransactionType,action);
				txn.copyFileToDGC(txnFilePath, AppConstants.DGC_PATH,action);				
				...
				journeyHistory.verifyJourneyHistory(context,entryStationName1,exitStationName3,action);
