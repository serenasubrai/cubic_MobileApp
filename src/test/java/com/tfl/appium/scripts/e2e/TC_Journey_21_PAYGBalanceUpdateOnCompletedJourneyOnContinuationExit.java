...
public class TC_Journey_21_PAYGBalanceUpdateOnCompletedJourneyOnContinuationExit extends AppiumEngine{
	...
	public void verifyOysterPAYGBalanceUpdateOnCompletedJourney(ITestContext context,Hashtable<String, String> data)
			throws Throwable {
