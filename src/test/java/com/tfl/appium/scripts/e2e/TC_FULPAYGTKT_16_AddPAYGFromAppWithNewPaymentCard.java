...
public class TC_FULPAYGTKT_16_AddPAYGFromAppWithNewPaymentCard extends AppiumEngine{
	...
	public void verifyOysterTopupWithNewPaymentCard(ITestContext context,Hashtable<String, String> data)
			throws Throwable {
		...
		try {
				...
				paymentCard.addNewPaymentCard(context, data, action);
				paymentCard.addBliingAddress(context, data, action);
				paymentCard.payWithNewCard(context, data, action);
