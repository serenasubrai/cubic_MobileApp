...
public class TC_Journey_16_PAYGBalanceUpdateOnWimbledonTramFollowedByExitAtWimbledonGateWithinSSTOfWimbledonTram extends AppiumEngine{
	...
	public static String VoidTramTransactionType = "VoidTRAM";
	...
	public void verifyOysterBalanceUpdateOnWimbledonTramFollowedByExitGateAtWimbledonSST(ITestContext context,Hashtable<String, String> data)
			throws Throwable {
		...
		Object VoidTramTransactionObject = JsonUtil.getJsonObject(TransactionData, "$.VoidTRAM");
		...
		String VoidTramStationName = JsonUtil.getJsonObjectElement(VoidTramTransactionObject, ".StationName");
		...
		try {
				...
				txn.copyFileToDGC(txnFilePath, AppConstants.DGC_PATH,action);
				txnFilePath = txn.generateViodTramTap(data,TransactionFile,TramStationName,VoidTramTransactionType,action);
				txn.copyFileToDGC(txnFilePath, AppConstants.DGC_PATH,action);
