...
public class TC_Journey_13_PAYGBalanceUpdateOnEntryFollowedByNoExitAndCompleteJourney extends AppiumEngine{
	...
	public void verifyOysterPAYGEntryNoExitAndCompleteJourney(ITestContext context,Hashtable<String, String> data)
			throws Throwable {
