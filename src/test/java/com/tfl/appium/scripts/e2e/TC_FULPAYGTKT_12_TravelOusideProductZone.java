...
public class TC_FULPAYGTKT_12_TravelOusideProductZone extends AppiumEngine{
	...
	public void verifyTKTTravelOutsideProductZone(ITestContext context,Hashtable<String, String> data)
			throws Throwable {
		...
		try {
				...
				if(!(product.verifyZonesApplied(context,data,action,data.get("ZoneRanges")))){
					...
					//throw new RuntimeException("Zone Ranges "+data.get("ZoneRanges")+" were not applied");
				}
