...
public class TC_Journey_05_TKTUpdateOnExitDuringUnstartedJourney extends AppiumEngine{
	...
	public void verifyOysterProductAtExitStationDuringUnstartedJourney(ITestContext context,Hashtable<String, String> data)
			throws Throwable {
		...
		String entryStationName =  ""; // providing null because this transaction should not have an entry station.
