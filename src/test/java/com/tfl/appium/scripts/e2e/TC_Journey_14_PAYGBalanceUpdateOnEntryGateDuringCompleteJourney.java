...
public class TC_Journey_14_PAYGBalanceUpdateOnEntryGateDuringCompleteJourney extends AppiumEngine{
	...
	public void verifyOysterPAYGEntryDuringCompleteJourney(ITestContext context,Hashtable<String, String> data)
			throws Throwable {
