...
public class TC_Journey_09_PAYGBalanceUpdateOnCableCarORHS1ORGatwickEntryGateFollowedByAnExit extends AppiumEngine{
	...
	public void verifyOysterPAYGBalanceUpdateEntryAtGatwick(ITestContext context,Hashtable<String, String> data)
			throws Throwable {
