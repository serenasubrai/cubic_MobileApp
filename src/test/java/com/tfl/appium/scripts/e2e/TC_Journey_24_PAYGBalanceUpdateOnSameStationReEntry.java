...
public class TC_Journey_24_PAYGBalanceUpdateOnSameStationReEntry extends AppiumEngine{
	...
	public void verifyOysterPAYGBalanceUpdateOnSameStationReEntry(ITestContext context,Hashtable<String, String> data)
			throws Throwable {
		...
		try {
				...
				System.out.println("********** Waiting for Journey Histories to update **********");
				Thread.sleep(40000);
