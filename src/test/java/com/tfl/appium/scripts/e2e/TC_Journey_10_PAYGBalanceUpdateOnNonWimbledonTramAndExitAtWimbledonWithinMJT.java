...
public class TC_Journey_10_PAYGBalanceUpdateOnNonWimbledonTramAndExitAtWimbledonWithinMJT extends AppiumEngine{
	...
	public void verifyOysterBalanceUpdateOnNonWimbledonTram(ITestContext context,Hashtable<String, String> data)
			throws Throwable {
		...
		try {
				...
				journeyHistory.verifyTramJournies(context, TramStationName,exitStationName, action);
