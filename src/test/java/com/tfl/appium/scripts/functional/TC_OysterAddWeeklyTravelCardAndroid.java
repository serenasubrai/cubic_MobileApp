...
public class TC_OysterAddWeeklyTravelCardAndroid extends AppiumEngine{
	...
	public void verifyOysterAddWeeklyTravelCard(ITestContext context,Hashtable<String, String> data)
			throws Throwable {
		...
		try {
			if (data.get("RunMode").equals("Y")) {
				...
				AddTravelCard.addWeeklyTravelCard(action);
