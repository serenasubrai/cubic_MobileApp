...
public class TC_OysterAddAnualTravelCardIOS extends AppiumEngine{
	com.tfl.appium.lib.OysterLoginIOS login = new com.tfl.appium.lib.OysterLoginIOS();
	com.tfl.appium.lib.OysterAddTravelCardIOS AddTravelCard = new com.tfl.appium.lib.OysterAddTravelCardIOS();
	com.tfl.appium.lib.OysterChangeCardDetailsIOS changeCard = new com.tfl.appium.lib.OysterChangeCardDetailsIOS();
	...
	public void verifyOysterAddAnualTravelCard(ITestContext context,Hashtable<String, String> data)
		...
		try {
			if (data.get("RunMode").equals("Y")) {
				...
				AddTravelCard.addAnualTravelCard(action);
				AddTravelCard.selectZone(action);
