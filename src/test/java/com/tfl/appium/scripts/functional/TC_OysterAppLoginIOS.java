...
public class TC_OysterAppLoginIOS extends AppiumEngine{
	com.tfl.appium.lib.OysterLoginIOS oyster = new com.tfl.appium.lib.OysterLoginIOS();
	...
	public void verifyOysterTopUP(ITestContext context,Hashtable<String, String> data)
		...
		try {
			if (data.get("RunMode").equals("Y")) {
				...
				oyster.verifyAppLogin(data, action);
			}
		} catch (Exception e) {
			e.printStackTrace();
